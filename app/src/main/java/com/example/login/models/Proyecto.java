...
public class Proyecto {
    ...
    public Proyecto(String id, String nombre, String descripcion, String compartir, List<Actividad> pendientes, List<Actividad> inProgress, List<Actividad> finalizadas) {
        this.id = id;
        this.nombre = nombre;
